...
Demonstrate [Infrastructure-as-Code](https://en.wikipedia.org/wiki/Infrastructure_as_code) to automate deployment on [IBM Cloud](https://www.ibm.com/cloud) for consistent development, testing, and deployment of workloads in [IBM Cloud VPC Infrastructure](https://www.ibm.com/cloud/vpc) utilizing [IBM Cloud Schematics](https://cloud.ibm.com/docs/schematics?topic=schematics-getting-started), [HashiCorp's Terraform](https://www.terraform.io/), and [Red Hat's Ansible](https://www.redhat.com/en/technologies/management/ansible).
