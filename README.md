...
Demonstrate [Infrastructure-as-Code](https://en.wikipedia.org/wiki/Infrastructure_as_code) to automate deployment on [IBM Cloud](https://www.ibm.com/cloud) for a consistent and faster development, testing, and deployment of workloads in [IBM Cloud VPC Infrastructure](https://www.ibm.com/cloud/vpc) utilizing [HashiCorp's Terraform](https://www.terraform.io/), and [Red Hat's Ansible](https://www.redhat.com/en/technologies/management/ansible).
